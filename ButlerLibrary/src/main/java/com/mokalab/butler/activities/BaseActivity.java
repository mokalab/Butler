...
public abstract class BaseActivity extends Activity implements
    ...
    @Override
    public void replaceFragment(final int containerResId, @NotNull final BaseFragment fragment, @Nullable final String fragmentTag,
            final boolean addToBackStack, final String backStackName,
